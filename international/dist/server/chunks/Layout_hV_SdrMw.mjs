...
import 'kleur/colors';
import 'clsx';
import { f as fetchPageContent } from './db_BLiRlGFB.mjs';
/* empty css                          */
...
function getCountryCssVariables() {
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const countryHeader = Astro2.request.headers.get("x-country-site");
  ...
  countryInfo?.slug || getCountrySlug();
  const basePath = "/dubai";
...
`;
  return renderTemplate(_a || (_a = __template(['<html lang="en" class="dark" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml"', '><meta name="generator"', '><meta name="description"', ">", "<title>", '</title><link href="https://cdn.jsdelivr.net/npm/flowbite@3.1.2/dist/flowbite.min.css" rel="stylesheet"><!-- Define global path helpers --><script>', "</script><!-- Add country-specific styles --><style>", "</style><!-- Country context initialization --><script>", "</script>", "", '</head> <body data-astro-cid-sckkx6r4> <div id="banner" data-astro-cid-sckkx6r4> ', " </div> ", " ", " <!-- <button onclick=`${connectDB}`>button </button> --> ", ' <script src="https://cdn.jsdelivr.net/npm/flowbite@3.0.0/dist/flowbite.min.js"></script> </body> </html>'], ['<html lang="en" class="dark" data-astro-cid-sckkx6r4> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml"', '><meta name="generator"', '><meta name="description"', ">", "<title>", '</title><link href="https://cdn.jsdelivr.net/npm/flowbite@3.1.2/dist/flowbite.min.css" rel="stylesheet"><!-- Define global path helpers --><script>', "</script><!-- Add country-specific styles --><style>", "</style><!-- Country context initialization --><script>", "</script>", "", '</head> <body data-astro-cid-sckkx6r4> <div id="banner" data-astro-cid-sckkx6r4> ', " </div> ", " ", " <!-- <button onclick=\\`\\${connectDB}\\`>button </button> --> ", ' <script src="https://cdn.jsdelivr.net/npm/flowbite@3.0.0/dist/flowbite.min.js"></script> </body> </html>'])), addAttribute(`${basePath}/favicon.svg`, "href"), addAttribute(Astro2.generator, "content"), addAttribute(`Erovoutika International Site for ${countryName}`, "content"), countryInfo && renderTemplate`<meta name="x-country-site"${addAttribute(JSON.stringify(countryInfo), "content")}>`, siteTitle, unescapeHTML(script), unescapeHTML(`
          :root {
            ${countryCssVars}
          }
