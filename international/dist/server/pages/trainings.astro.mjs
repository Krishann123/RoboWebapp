...
const $$Trainings = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const content = {
    Introduction: {
      title: "Seminars & Workshop Programs",
      subtitle: "Enhance your skills with our comprehensive seminar & workshop programs in Robotics, Automation, and Artificial Intelligence, designed for global participants."
    },
    Content_1: {
      title: "Robotics & Automation",
      subtitle: "Our Robotics and Automation seminars provides hands-on experience with the latest technologies, from industrial robots to autonomous systems. Learn to design, build, and program robots for various applications.",
      ImageDirectory: "/images/training/robotics.png"
    },
    Content_2: {
      title: "Artificial Intelligence",
      subtitle: "We provide cutting-edge Artificial Intelligence education with projects, personalized learning and a focus for ethical development",
      ImageDirectory: "/images/training/cybersecurity.png"
    },
    Content_3: {
      title: "Research & Development",
      subtitle: "Join our R&D Workshops to work on cutting-edge projects. This program focuses on innovation, problem-solving, and contributing to new advancements in technology.",
      ImageDirectory: "/images/training/research.png"
    },
    Content_4: {
      title: "Register for Seminars & Workshops",
      subtitle: "Ready to advance your career? Enroll in our seminar & Workshop programs and become an expert in your field.",
...
}, "C:/Users/Krishann/Desktop/RoboWebapp/international/src/pages/Trainings.astro", void 0);

const $$file = "C:/Users/Krishann/Desktop/RoboWebapp/international/src/pages/Trainings.astro";
