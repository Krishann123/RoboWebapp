...
const logo = new Proxy({"src":"/dubai/_astro/Erovoutika Dubai logo.DqaA4qgV.png","width":209,"height":68,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Krishann/Desktop/RoboWebapp/international/src/assets/images/Erovoutika Dubai logo.png";
							}
...
const show_password_icon = new Proxy({"src":"/dubai/_astro/show-password.JZZGCVaN.png","width":19,"height":15,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Krishann/Desktop/RoboWebapp/international/src/assets/images/utility-icons/show-password.png";
							}
...
const hide_password_icon = new Proxy({"src":"/dubai/_astro/hide-password.CycqiXUW.png","width":18,"height":17,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "C:/Users/Krishann/Desktop/RoboWebapp/international/src/assets/images/utility-icons/hide-password.png";
							}
...
If this email is registered, a reset link has
                                been sent.
</div> </form> </div> </div> </div> </div> </section> ` })}  ${renderScript($$result, "C:/Users/Krishann/Desktop/RoboWebapp/international/src/pages/login.astro?astro&type=script&index=0&lang.ts")}`;
}, "C:/Users/Krishann/Desktop/RoboWebapp/international/src/pages/login.astro", void 0);

const $$file = "C:/Users/Krishann/Desktop/RoboWebapp/international/src/pages/login.astro";
