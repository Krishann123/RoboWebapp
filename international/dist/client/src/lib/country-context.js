...
// Country configurations - add more countries as needed
...
function getCountryInfo() {
  ...
  try {
    ...
    // URL format: /{country}/* or /country/{slug}/*
    const pathParts = window.location.pathname.split('/');
    
    // Handle direct country path: /{country}/*
    if (pathParts[1] && countryConfigs[pathParts[1]]) {
      return countryConfigs[pathParts[1]];
    }
    
    // Handle legacy country path: /country/{slug}/*
