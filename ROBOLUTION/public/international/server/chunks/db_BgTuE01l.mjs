...
async function getCountryTournament(countrySlug) {
  try {
...
async function getCountryTraining(countrySlug) {
  try {
...
export { getPageDetails as a, getData as b, getSelectedIndex as c, addNewsCard as d, getCountryTournament as e, fetchPageContent as f, getCountryContent as g, getCountryTraining as h, setSelectedIndex as s, updateContent as u };
